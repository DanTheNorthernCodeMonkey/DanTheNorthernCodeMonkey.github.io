...
!function(){function e(){o.pushManager.subscribe({userVisibleOnly:!0}).then(function(e){t=e,console.log("Subscribed! Endpoint:",t.endpoint),i.textContent="Unsubscribe",r=!0})}function n(){t.unsubscribe().then(function(e){i.textContent="Subscribe",console.log("Unsubscribed!",e),r=!1}).catch(function(e){console.log("Error unsubscribing",e),i.textContent="Subscribe"})}var o,t,r=!1,i=document.querySelector(".button"),c=document.querySelector(".register");"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js",{scope:"/"}).then(function(e){console.log("ServiceWorker registration successful with scope: ",e.scope),o=e,i.disabled=!1}).catch(function(e){console.log("ServiceWorker registration failed: ",e)}),i&&i.addEventListener("click",function(){r?n():e()}),c&&c.addEventListener("click",function(e){e.preventDefault(),new Promise(function(e,n){Notification.requestPermission(function(o){return"granted"!==o?n(Error("Denied notification permission")):void e()})}).then(function(){return navigator.serviceWorker.ready}).then(function(e){return e.sync.register("sync")}).then(function(){console.log("Sync registered")}).catch(function(e){console.log("It broke"),console.log(e.message)})})}();
