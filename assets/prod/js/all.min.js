...
!function(){function e(){r.pushManager.subscribe({userVisibleOnly:!0}).then(function(e){i=e,console.log("Subscribed! Endpoint:",i.endpoint),s.textContent="Unsubscribe",c=!0})}function n(){i.unsubscribe().then(function(e){s.textContent="Subscribe",console.log("Unsubscribed!",e),c=!1}).catch(function(e){console.log("Error unsubscribing",e),s.textContent="Subscribe"})}function o(e){u&&(e.preventDefault(),new Promise(function(e,n){Notification.requestPermission(function(o){return"granted"!==o?n(Error("Denied notification permission")):void e()})}).then(function(){return navigator.serviceWorker.ready}).then(function(e){return e.sync.register("sync")}).then(function(){console.log("Sync registered")}).catch(function(e){console.log("It broke"),console.log(e.message)}))}function t(){null!==s&&s.addEventListener("click",function(){c?n():e()}),u=document.querySelector(".register"),null!==u&&u.addEventListener("click",function(e){o(e)})}var r,i,c=!1,s=document.querySelector(".button"),u=document.querySelector(".register");"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js",{scope:"/"}).then(function(e){console.log("ServiceWorker registration successful with scope: ",e.scope),r=e,t(),s&&(s.disabled=!1)}).catch(function(e){console.log("ServiceWorker registration failed: ",e)})}();