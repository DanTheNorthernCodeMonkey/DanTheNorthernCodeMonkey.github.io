...
$(function(){function n(){i.pushManager.subscribe({userVisibleOnly:!0}).then(function(n){r=n,console.log("Subscribed! Endpoint:",r.endpoint),s.textContent="Unsubscribe",c=!0})}function e(){r.unsubscribe().then(function(n){s.textContent="Subscribe",console.log("Unsubscribed!",n),c=!1}).catch(function(n){console.log("Error unsubscribing",n),s.textContent="Subscribe"})}function o(n){u&&(n.preventDefault(),new Promise(function(n,e){Notification.requestPermission(function(o){return"granted"!==o?e(Error("Denied notification permission")):void n()})}).then(function(){return navigator.serviceWorker.ready}).then(function(n){return n.sync.register("sync")}).then(function(){console.log("Sync registered")}).catch(function(n){console.log("It broke"),console.log(n.message)}))}function t(){s.length>0&&s.on("click",function(){c?e():n()}),u.length>0&&u.on("click",function(n){o(n)})}var i,r,c=!1,s=$(".subscribe"),u=$(".register");"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js",{scope:"/"}).then(function(n){console.log("ServiceWorker registration successful with scope: ",n.scope),i=n,t()}).catch(function(n){console.log("ServiceWorker registration failed: ",n)})});