...
$(function(){function n(){r.pushManager.subscribe({userVisibleOnly:!0}).then(function(n){t=n,console.log("Subscribed! Endpoint:",t.endpoint),s.text("Unsubscribe"),c=!0})}function e(){t.unsubscribe().then(function(n){s.text("Subscribe"),console.log("Unsubscribed!",n),c=!1}).catch(function(n){console.log("Error unsubscribing",n),s.text("Subscribe")})}function o(n){u&&(n.preventDefault(),new Promise(function(n,e){Notification.requestPermission(function(o){return"granted"!==o?e(Error("Denied notification permission")):void n()})}).then(function(){return navigator.serviceWorker.ready}).then(function(n){return n.sync.register("sync")}).then(function(){console.log("Sync registered")}).catch(function(n){console.log("It broke"),console.log(n.message)}))}function i(){s.length>0&&s.on("click",function(){c?e():n()}),u.length>0&&u.on("click",function(n){o(n)})}var r,t,c=!1,s=$(".subscribe"),u=$(".register");"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js",{scope:"/"}).then(function(n){console.log("ServiceWorker registration successful with scope: ",n.scope),r=n,i()}).catch(function(n){console.log("ServiceWorker registration failed: ",n)})});